    ...
    >
      <div
        ...
        onMouseEnter={(e) => {
          ...
          const iconElement = e.currentTarget.querySelector('.category-icon') as HTMLElement;
          const textElement = e.currentTarget.querySelector('.category-text') as HTMLElement;
          if (iconElement) iconElement.style.filter = "grayscale(0%) brightness(0) invert(1)";
        ...
        onMouseLeave={(e) => {
          ...
          const iconElement = e.currentTarget.querySelector('.category-icon') as HTMLElement;
          const textElement = e.currentTarget.querySelector('.category-text') as HTMLElement;
          if (iconElement) iconElement.style.filter = "grayscale(100%) brightness(0.6)";
